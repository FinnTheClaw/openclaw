...
const GENERATED_DREAMING_RELATIVE_DIR = "memory/dreaming";
...
/** Skips legacy, repair, and generated reflection paths when scanning workspace memory files. */
export function shouldSkipRootMemoryAuxiliaryPath(params: {
  ...
  return (
    ...
    normalized === GENERATED_DREAMING_RELATIVE_DIR ||
    normalized.startsWith(`${GENERATED_DREAMING_RELATIVE_DIR}/`)
  );
}
