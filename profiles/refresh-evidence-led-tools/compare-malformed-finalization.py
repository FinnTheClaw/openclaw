"""Two-case live qualification plan for malformed-terminal finalization."""
import argparse
...
PACKAGE = Path("/workspace/goal-anchored-continuation-runtime-62c83212")
...
REVISION = "62c83212e3d7f54397491d0339158792a381316c"
...
def main():
    ...
    keys = ["R06-append-once", "R20-two-turn-change"]
    selected = []
    for key in keys:
        case = by_id[key]
    ...
    manifest = {
        ...
        "callerRetries": 0, "treatment": "Source-onlyc74d3d54 versus62c83212; no guidance profile; unchanged native retry budgets",
