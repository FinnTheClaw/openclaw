"""Six-case source-only comparison of goal-anchored continuation."""
import argparse
...
def main():
    ...
    keys = ["R06-append-once", "R09-noop-present", "R11-read-arithmetic", "R13-missing-source", "R20-two-turn-change", "D14-multiple-matches"]
    selected = []
    for key in keys:
        case = by_id[key]
