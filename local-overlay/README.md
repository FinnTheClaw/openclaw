...
| `patches/openclaw-2026.7.1-2/tool-chain-empty-progress-recovery.patch`    | `2026.7.1-2`                     | `dist/embedded-agent-DGUuxGR2.js`                                                                                                                    | Find the latest successful tool batch even when the model appends an empty assistant stop, renew a bounded continuation budget whenever tool progress advances, and preserve the full tool set while exact-action replay protection blocks duplicate mutations.        |
...
| `patches/openclaw-2026.7.1-2/local-model-orchestration-v29.patch`          | `2026.7.1-2`                     | `dist/tool-search-B8B4Spes.js`, `dist/selection-JInn13lc.js`                                                                                         | Expose memory search/get plus spawn/yield directly to lean local-model parents and preserve recently settled child state across partial completion wakes.                                                                                                             |
